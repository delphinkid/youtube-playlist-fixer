...
function stuff() {
  ...
  vidlist = document.getElementsByClassName("yt-simple-endpoint style-scope ytd-playlist-video-renderer");
...
//besto();
//setTimeout(checkEm, 1000);
timmy = setInterval(checkEm, 500);
//clearInterval(timmy);
//window.onpopstate = beeper;
//window.onscroll = beeper;
window.onblur = function(){clearInterval(timmy)};
//window.onblur = function(){console.log("howdy howdy howdy")};
window.onfocus = function(){timmy = setInterval(checkEm, 500)};
